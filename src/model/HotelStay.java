...
public final class HotelStay extends TourService {
  ...
  public HotelStay(Integer x, String name, BigDecimal price, LocalDate from, LocalDate to,
  ...
  public String toString() {
    return "User{Сколько звезд=\"" + stars + "\", Сколько ночей=\"" + nights +
        "\", Тип комнаты=\"" + (roomType != null ? roomType.name() : "null") + "\", X=\"" + getX() +
        "\", Name=\"" + getName() + "\", From=\"" + getFrom() + "\", To=\"" + getTo() +
        "\", Price=\"" + getPrice() + "\"}";
  }
